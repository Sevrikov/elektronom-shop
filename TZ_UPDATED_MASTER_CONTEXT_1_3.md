...
> ⚠️ **Снапшот статуса от 2026-05-21 — УСТАРЕЛ.** Перечисленное здесь как «осталось сделать» (checkout, auth/account, admin, search, SEO) на 2026-05-30 уже реализовано. Дословное следование этому файлу приведёт к пересозданию/откату рабочего кода. **Актуальный операционный план: `TZ_FIXES_MASTER_2026-05-31.md`** (с anti-regression guard). Этот файл — для истории и как описание правил-протокола.
