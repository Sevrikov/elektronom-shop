        ...
        {inStock && (
          <>
            <div className="flex items-center border border-border rounded-lg bg-surface-white h-11 px-1 shrink-0 select-none">
              ...
              <span className="w-10 text-center font-extrabold text-text-primary text-[15px] pointer-events-none select-none">
                {qty}
              </span>
              <button
                type="button"
            ...
            <div className="flex flex-col leading-tight">
              ...
              <span className="text-xl font-extrabold num leading-none text-text-primary">
