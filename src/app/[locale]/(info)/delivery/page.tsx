...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const uk = locale !== 'ru'
  return {
    title: `${uk ? 'Доставка та оплата' : 'Доставка и оплата'} | ЕЛЕКТРОНОМ`,
    description: uk
      ? 'Умови доставки та оплати в інтернет-магазині ЕЛЕКТРОНОМ. Доставка по Україні Новою поштою від 1 дня.'
      : 'Условия доставки и оплаты в интернет-магазине ЕЛЕКТРОНОМ. Доставка по Украине Новой почтой от 1 дня.',
  }
}
