...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const uk = locale !== 'ru'
  return {
    title: `${brand.name} — ${uk ? 'товари' : 'товары'} | Electronom`,
    description: uk
      ? `Купити товари бренду ${brand.name} в інтернет-магазині Electronom. Офіційний дистриб'ютор, оригінальна продукція, швидка доставка.`
      : `Купить товары бренда ${brand.name} в интернет-магазине Electronom. Официальный дистрибьютор, оригинальная продукция, быстрая доставка.`,
  }
}
