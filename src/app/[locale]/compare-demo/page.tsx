...
const products: CompareProduct[] = [
  { id: '1', name: 'ASKO UTrust 1P+N 40A', image: null, values: { price: 884, breaking: 6, ip: 20, current: 40, poles: '2P', weight: 0.25 } },
  { id: '2', name: 'Hager CDA240D 40A', image: null, values: { price: 1290, breaking: 10, ip: 20, current: 40, poles: '2P', weight: 0.30 } },
  { id: '3', name: 'Schneider Acti9 iID 40A', image: null, values: { price: 1150, breaking: 6, ip: 40, current: 40, poles: '2P', weight: 0.28 } },
  { id: '4', name: 'ABB FH202 40A', image: null, values: { price: 1490, breaking: 10, ip: 40, current: 40, poles: '2P', weight: 0.22 } },
]
