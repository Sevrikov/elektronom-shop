...
export const catalogProducts: CatalogProduct[] = [
  ...
  // Кабель
  { id: 'c13', slug: 'vvgng-ls-3x2-5', brand: 'ОДЕСКАБЕЛЬ', name: { uk: 'Кабель ВВГнг-LS 3×2.5 мм² (100м)', ru: 'Кабель ВВГнг-LS 3×2.5 мм² (100м)' }, sku: 'ODS-VVG-325-100', price: 3240, stock: 80, categorySlug: 'kabel-ta-provid', icon: 'cable', qtyBreaks: [{ minQty: 5, unitPrice: 2980.80 }, { minQty: 20, unitPrice: 2851.20 }, { minQty: 100, unitPrice: 2721.60 }], rating: 4.6, reviewsCount: 89, attributes: { cable_type: 'ВВГнг-LS', cores: '3', section: '2.5' } },
  { id: 'c14', slug: 'vvgng-3x1-5', brand: 'ОДЕСКАБЕЛЬ', name: { uk: 'Кабель ВВГнг 3×1.5 мм² (100м)', ru: 'Кабель ВВГнг 3×1.5 мм² (100м)' }, sku: 'ODS-VVG-315-100', price: 2180, stock: 120, categorySlug: 'kabel-ta-provid', icon: 'cable', qtyBreaks: [{ minQty: 5, unitPrice: 2005.60 }, { minQty: 20, unitPrice: 1919.50 }, { minQty: 100, unitPrice: 1831.20 }], rating: 4.5, reviewsCount: 67, attributes: { cable_type: 'ВВГнг', cores: '3', section: '1.5' } },
  { id: 'c15', slug: 'pvs-3x1-5', brand: 'ОДЕСКАБЕЛЬ', name: { uk: 'Провід ПВС 3×1.5 мм² (100м)', ru: 'Провод ПВС 3×1.5 мм² (100м)' }, sku: 'ODS-PVS-315', price: 1850, stock: 200, categorySlug: 'kabel-ta-provid', icon: 'cable', qtyBreaks: [{ minQty: 10, unitPrice: 1665 }, { minQty: 50, unitPrice: 1572.50 }, { minQty: 200, unitPrice: 1480 }], rating: 4.4, reviewsCount: 45, attributes: { cable_type: 'ПВС', cores: '3', section: '1.5' } },
  // Розетки
  { id: 'c16', slug: 'legrand-valena-life-white', brand: 'LEGRAND', name: { uk: 'Розетка Legrand Valena Life біла з/з', ru: 'Розетка Legrand Valena Life белая с/з' }, sku: '752820', price: 186, stock: 400, categorySlug: 'rozetky-ta-vymykachi', icon: 'plug', qtyBreaks: [{ minQty: 20, unitPrice: 163.68 }, { minQty: 50, unitPrice: 155.82 }, { minQty: 200, unitPrice: 148.80 }], rating: 4.7, reviewsCount: 312, attributes: { type: 'Розетка', series: 'Valena Life', color: 'Білий' } },
  { id: 'c17', slug: 'schneider-asfora-white-switch', brand: 'SCHNEIDER', name: { uk: 'Вимикач Schneider Asfora 1-кл. білий', ru: 'Выключатель Schneider Asfora 1-кл. белый' }, sku: 'EPH0100121', price: 95, stock: 350, categorySlug: 'rozetky-ta-vymykachi', icon: 'plug', qtyBreaks: [{ minQty: 20, unitPrice: 85.50 }, { minQty: 50, unitPrice: 80.75 }, { minQty: 200, unitPrice: 76 }], rating: 4.3, reviewsCount: 189, attributes: { type: 'Вимикач', series: 'Asfora', color: 'Білий' } },
  { id: 'c18', slug: 'legrand-valena-life-frame-2', brand: 'LEGRAND', name: { uk: 'Рамка 2-місна Legrand Valena Life біла', ru: 'Рамка 2-местная Legrand Valena Life белая' }, sku: '754002', price: 78, stock: 280, categorySlug: 'rozetky-ta-vymykachi', icon: 'plug', qtyBreaks: [{ minQty: 20, unitPrice: 66.30 }, { minQty: 50, unitPrice: 62.40 }, { minQty: 200, unitPrice: 58.50 }], rating: 4.8, reviewsCount: 245, attributes: { type: 'Рамка', series: 'Valena Life', color: 'Білий' } },
  // LED
  { id: 'c19', slug: 'philips-led-panel-40w', brand: 'PHILIPS', name: { uk: 'LED-панель Philips 40W 6500K 600×600', ru: 'LED-панель Philips 40W 6500K 600×600' }, sku: 'PHL-LP40-65K', price: 1280, stock: 90, categorySlug: 'osvitlennya-led', icon: 'lightbulb', qtyBreaks: [{ minQty: 10, unitPrice: 1152 }, { minQty: 50, unitPrice: 1088 }, { minQty: 200, unitPrice: 1024 }], rating: 4.6, reviewsCount: 178, attributes: { led_type: 'Панель', wattage: '40', color_temp: '6500' } },
  { id: 'c20', slug: 'osram-led-bulb-12w', brand: 'OSRAM', name: { uk: 'Лампа LED Osram 12W E27 4000K', ru: 'Лампа LED Osram 12W E27 4000K' }, sku: 'OSR-LED12-4K', price: 89, stock: 600, categorySlug: 'osvitlennya-led', icon: 'lightbulb', qtyBreaks: [{ minQty: 30, unitPrice: 80.10 }, { minQty: 100, unitPrice: 75.65 }, { minQty: 500, unitPrice: 71.20 }], rating: 4.4, reviewsCount: 432, attributes: { led_type: 'Лампа', wattage: '12', color_temp: '4000' } },
  { id: 'c21', slug: 'iek-dpo-2001-18w', brand: 'IEK', name: { uk: 'Світильник LED IEK ДПО 2001 18W IP54', ru: 'Светильник LED IEK ДПО 2001 18W IP54' }, sku: 'LDPO0-2001', price: 412, stock: 150, categorySlug: 'osvitlennya-led', icon: 'lightbulb', qtyBreaks: [{ minQty: 10, unitPrice: 378.32 }, { minQty: 50, unitPrice: 354.32 }, { minQty: 200, unitPrice: 329.60 }], rating: 4.2, reviewsCount: 98, attributes: { led_type: 'Світильник', wattage: '18', color_temp: '6500' } },
  { id: 'c22', slug: 'philips-led-strip-5m', brand: 'PHILIPS', name: { uk: 'Стрічка LED Philips 5м 3000K 14.4W/м', ru: 'Лента LED Philips 5м 3000K 14.4W/м' }, sku: 'PHL-STRIP-5M', price: 680, stock: 75, categorySlug: 'osvitlennya-led', icon: 'lightbulb', qtyBreaks: [{ minQty: 10, unitPrice: 625.60 }, { minQty: 50, unitPrice: 578 }, { minQty: 200, unitPrice: 544 }], rating: 4.5, reviewsCount: 56, attributes: { led_type: 'Стрічка', wattage: '72', color_temp: '3000' } },
