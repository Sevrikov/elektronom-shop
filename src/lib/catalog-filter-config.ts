...
export const categoryFilterConfig: Record<string, FilterConfig> = {
  'avtomatychni-vymykachi': {
    ...
    quickLinks: [
      ...
      { label: { uk: '16А струм',           ru: '16А ток' },             filter: { key: 'rated_current', value: '16' } },
      { label: { uk: '25А струм',           ru: '25А ток' },             filter: { key: 'rated_current', value: '25' } },
      { label: { uk: '40А струм',           ru: '40А ток' },             filter: { key: 'rated_current', value: '40' } },
      { label: { uk: 'Хар-ка B',            ru: 'Хар-ка B' },            filter: { key: 'curve', value: 'B' } },
      { label: { uk: 'Хар-ка C',            ru: 'Хар-ка C' },            filter: { key: 'curve', value: 'C' } },
      { label: { uk: 'Хар-ка D',            ru: 'Хар-ка D' },            filter: { key: 'curve', value: 'D' } },
      { label: { uk: 'ABB',                 ru: 'ABB' },                 filter: { key: 'brand', value: 'abb' } },
      { label: { uk: 'Schneider',           ru: 'Schneider' },           filter: { key: 'brand', value: 'schneider-electric' } },
