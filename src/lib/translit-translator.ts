...
const KEY_PRIORITY = [
  ...
  'ratedcurrenta',
  'nomynaln_y_tok',
  'nominalnyy_robochyy_strum_ie_a',
  'nominalna_robocha_napruha_ue_v',
  'nomynalnoe_rabochee_napryazhenye_po_peremennomu_toku',
  'nominalna_napruha_v',
  'napruga',
  'strum',
  'chastota_toka',
  'skorist',
  'klichestvo_polusov',
  'kolychestvo_polyusov',
  'kilkist_polusiv',
  'poles',
  'kolychestvo_moduley',
  'curve',
  'kharakterystyka_vidklyuchennya',
  'engineeringrole',
  'standard',
  ...
  'nominalna_vymykayucha_zdatnist_icn_ka',
  ...
  'pereriz_pid_yednuvalnykh_provodiv_mm_kv',
  'dyapazon_rabochaia_temperatura_c',
  'temperatura_ekspluatatsiyi_s',
  'temperatura',
  'rezhym_ekspluatatsiyi',
  'uslovyya_yspolzovanyya',
  'mekhanycheskaya_yznosostoykost',
  'kommutatsyonnaya_yznosostoykost',
  'znosostiykist_elektrychna_tsykliv',
  'znosostiykist_mekhanichna_tsykliv',
  'nominalna_impulsna_napruha_uimp_kv',
  'nominalna_napruha_izolyatsiyi_ui_v',
  'vaga',
  'razmery',
